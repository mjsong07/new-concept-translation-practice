...
const messages: Record<AppLocale, Record<string, string>> = {
  "zh-CN": {
    ...
    "notes.tabMine": "我的笔记",
    "notes.tabTextbook": "教材",
    "notes.tabClassNotes": "课堂笔记",
    "notes.tabHomework": "Homework",
    "notes.classNotesEmpty": "本课暂无课堂笔记",
    "notes.tabOriginal": "原书",
    "notes.hideAnswers": "隐藏回答",
    "notes.showAnswers": "显示回答",
    "notes.hideAnswersAll": "全部隐藏回答",
    "notes.showAnswersAll": "全部显示回答",
    "notes.homeworkTasks": "作业要求",
    "notes.homeworkQuestions": "Questions",
    "notes.homeworkHomework": "Homework",
    "notes.homeworkSummary": "Summary & Recap",
    "notes.homeworkQuestionsHint": "记录你遇到的问题",
    "notes.homeworkHomeworkHint": "完成本课课后作业",
    "notes.homeworkSummaryHint": "回忆并总结核心知识点",
    "notes.edit": "编辑",
    "notes.save": "保存",
    "notes.cancel": "取消",
    "notes.editHint": "记录本课要点、生词与心得，支持 Markdown。",
    "notes.textbookEmpty": "本课暂无教材内容",
    "theme.system": "跟随系统",
    "theme.light": "浅色",
    "theme.dark": "深色",
    "header.eyebrow": "新概念英语第一册",
    "header.title": "句子训练",
    ...
    "exercise.scopeHintWritten": "按例题填空或写出完整句子",
    "exercise.sentenceAnswer": "完整句子",
    "exercise.example": "例句",
    "exercise.showAnswers": "显示答案",
    "exercise.hideAnswers": "隐藏答案",
  ...
  en: {
    ...
    "notes.tabMine": "My Notes",
    "notes.tabTextbook": "Textbook",
    "notes.tabClassNotes": "Class Notes",
    "notes.tabHomework": "Homework",
    "notes.classNotesEmpty": "No class notes for this lesson yet",
    "notes.tabOriginal": "Original",
    "notes.hideAnswers": "Hide answers",
    "notes.showAnswers": "Show answers",
    "notes.hideAnswersAll": "Hide all answers",
    "notes.showAnswersAll": "Show all answers",
    "notes.homeworkTasks": "Homework tasks",
    "notes.homeworkQuestions": "Questions",
    "notes.homeworkHomework": "Homework",
    "notes.homeworkSummary": "Summary & Recap",
    "notes.homeworkQuestionsHint": "Write down your questions",
    "notes.homeworkHomeworkHint": "Do this lesson's homework",
    "notes.homeworkSummaryHint": "Recall and summarize the key points",
    "notes.edit": "Edit",
    "notes.save": "Save",
    "notes.cancel": "Cancel",
    "notes.editHint": "Record key points, new words, and takeaways. Markdown is supported.",
    "notes.textbookEmpty": "No textbook content for this lesson yet",
    "theme.system": "System",
    "theme.light": "Light",
    "theme.dark": "Dark",
    "header.eyebrow": "NEW CONCEPT ENGLISH · BOOK 1",
    "header.title": "Sentence Practice",
    ...
    "exercise.scopeHintWritten": "Fill the blank or write the full sentence",
    "exercise.sentenceAnswer": "full sentence",
    "exercise.example": "Example",
    "exercise.showAnswers": "Show answers",
    "exercise.hideAnswers": "Hide answers",
    ...
    "exercise.insertNewline": "Insert Newline",
